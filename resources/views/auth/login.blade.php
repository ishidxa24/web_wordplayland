...
<head>
    ...
    <title>Login - WordPlayland</title>
        ...
        <div class="w-full max-w-4xl grid md:grid-cols-2 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="flex flex-col justify-center bg-white p-8 sm:p-12">
                <div class="w-full">
                    ...
                    <h2 class="text-3xl font-bold mb-2 text-gray-800">Log in to your account</h2>
                    ...
                    <form method="POST" action="{{ route('login') }}" x-data="{ showPassword: false }">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="email" type="email" name="email" :value="old('email')" required autofocus class="mt-1 block w-full px-3 py-2 bg-white border-b-2 border-gray-300 focus:outline-none focus:border-indigo-500">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <span @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 cursor-pointer text-gray-500 hover:text-gray-700">
                                    Show
                                </span>
                            </div>
